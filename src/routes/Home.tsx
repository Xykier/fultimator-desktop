        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            <Typography variant="h5" sx={{ mb: 2, fontWeight: "bold" }}>
              ...
              >
                <DiscordIcon size={24} color={isDarkMode ? "#e0e0e0" : "#333333"} />
              </Box>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              {t("Check for new releases and updates here:")}{" "}
              <Link
              ...
              >
                {t("Fultimator Desktop App Releases")}
              </Link>
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Typography variant="body1" sx={{ mb: 2 }}>
              {t(
                "If you have any feedback or questions, feel free to reach out to us via email or our feedback form."
              )}{" "}
              <Link
